...
const MESSAGES: Record<TranslationUiLocale, TranslationUiMessages> = {
  en: {
    ...
    inlineTranslationIntro: 'Notes, articles, and profile bios auto-translate inline once a provider is configured. API keys stay in this browser session, are not persisted, and are never sent to relays.',
    providerLabel: 'Provider',
    useLocalDefaults: 'Use Local SMaLL-100 Defaults',
    transportLabel: 'Transport',
    storageLabel: 'Storage',
    storageEncrypted: 'Persistent storage disabled',
    storageSessionOnly: 'Session-only (not persisted)',
  ...
  es: {
    ...
    inlineTranslationIntro: 'Las notas, articulos y biografias se traducen en linea cuando un proveedor esta configurado. Las claves API permanecen en esta sesion del navegador, no se guardan y nunca se envian a los relays.',
    providerLabel: 'Proveedor',
    useLocalDefaults: 'Usar valores locales de SMaLL-100',
    transportLabel: 'Transporte',
    storageLabel: 'Almacenamiento',
    storageEncrypted: 'Persistencia desactivada',
    storageSessionOnly: 'Solo sesion (no se guarda)',
