...
export const FILTER_PRESETS: FilterPreset[] = [
  ...
  },
  {
    id: 'scam',
    name: 'Scams & Fraud',
    description: 'Identifies scam attempts, phishing, fraudulent schemes, and crypto rug-pulls',
    icon: '🎣',
    category: 'safety',
    filters: [
      {
  ...
  },
  {
    id: 'spam',
    name: 'Spam & Promotion',
    description: 'Filters excessive self-promotion, airdrop bait, giveaway spam, and bot content',
    icon: '📧',
    category: 'spam',
    filters: [
      {
