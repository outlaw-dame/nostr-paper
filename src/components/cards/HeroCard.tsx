      ...
      >
        ...
        >
          <motion.div style={{ y: pillY }} className="flex items-center gap-2 flex-wrap">
            ...
            {contentWarning && (
              <span className="inline-flex items-center gap-1.5 rounded-full bg-[rgb(var(--color-system-yellow)/0.18)] px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.14em] text-[rgb(var(--color-system-yellow))] backdrop-blur-md">
                ...
                <span>
                  Warning{contentWarning.reason ? `: ${contentWarning.reason}` : ''}
                </span>
              </span>
            )}
          </motion.div>
