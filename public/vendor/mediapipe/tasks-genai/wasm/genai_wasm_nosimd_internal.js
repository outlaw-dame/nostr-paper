...
var ASM_CONSTS = {
  2019640: () => !!Module["preinitializedWebGPUDevice"],
  2019691: () => {
  ...
  2019874: () => !!Module["preinitializedWebGPUDevice"],
  2019925: () => {
...
function assignWasmExports(wasmExports) {
  _free = Module["_free"] = wasmExports["$c"];
  _CreateLlmInferenceEngineConverted = Module["_CreateLlmInferenceEngineConverted"] = wasmExports["ad"];
  _DeleteLlmInferenceEngine = Module["_DeleteLlmInferenceEngine"] = wasmExports["bd"];
  _MakeSessionForPredict = Module["_MakeSessionForPredict"] = wasmExports["cd"];
  _AddTextQueryChunk = Module["_AddTextQueryChunk"] = wasmExports["dd"];
  _AddImageQueryChunk = Module["_AddImageQueryChunk"] = wasmExports["ed"];
  _AddAudioQueryChunk = Module["_AddAudioQueryChunk"] = wasmExports["fd"];
  _malloc = Module["_malloc"] = wasmExports["gd"];
  _PredictSession = Module["_PredictSession"] = wasmExports["hd"];
  _FreeSession = Module["_FreeSession"] = wasmExports["id"];
  _GetSizeInTokens = Module["_GetSizeInTokens"] = wasmExports["jd"];
  _wgpuDeviceAddRef = wasmExports["kd"];
  _registerModelResourcesGraphService = Module["_registerModelResourcesGraphService"] = wasmExports["ld"];
  _bindTextureToStream = Module["_bindTextureToStream"] = wasmExports["md"];
  _addBoundTextureToStream = Module["_addBoundTextureToStream"] = wasmExports["nd"];
  _addDoubleToInputStream = Module["_addDoubleToInputStream"] = wasmExports["od"];
  _addFloatToInputStream = Module["_addFloatToInputStream"] = wasmExports["pd"];
  _addBoolToInputStream = Module["_addBoolToInputStream"] = wasmExports["qd"];
  _addIntToInputStream = Module["_addIntToInputStream"] = wasmExports["rd"];
  _addUintToInputStream = Module["_addUintToInputStream"] = wasmExports["sd"];
  _addStringToInputStream = Module["_addStringToInputStream"] = wasmExports["td"];
  _addRawDataSpanToInputStream = Module["_addRawDataSpanToInputStream"] = wasmExports["ud"];
  _allocateBoolVector = Module["_allocateBoolVector"] = wasmExports["vd"];
  _allocateFloatVector = Module["_allocateFloatVector"] = wasmExports["wd"];
  _allocateDoubleVector = Module["_allocateDoubleVector"] = wasmExports["xd"];
  _allocateIntVector = Module["_allocateIntVector"] = wasmExports["yd"];
  _allocateUintVector = Module["_allocateUintVector"] = wasmExports["zd"];
  _allocateStringVector = Module["_allocateStringVector"] = wasmExports["Ad"];
  _addBoolVectorEntry = Module["_addBoolVectorEntry"] = wasmExports["Bd"];
  _addFloatVectorEntry = Module["_addFloatVectorEntry"] = wasmExports["Cd"];
  _addDoubleVectorEntry = Module["_addDoubleVectorEntry"] = wasmExports["Dd"];
  _addIntVectorEntry = Module["_addIntVectorEntry"] = wasmExports["Ed"];
  _addUintVectorEntry = Module["_addUintVectorEntry"] = wasmExports["Fd"];
  _addStringVectorEntry = Module["_addStringVectorEntry"] = wasmExports["Gd"];
  _addBoolVectorToInputStream = Module["_addBoolVectorToInputStream"] = wasmExports["Hd"];
  _addFloatVectorToInputStream = Module["_addFloatVectorToInputStream"] = wasmExports["Id"];
  _addDoubleVectorToInputStream = Module["_addDoubleVectorToInputStream"] = wasmExports["Jd"];
  _addIntVectorToInputStream = Module["_addIntVectorToInputStream"] = wasmExports["Kd"];
  _addUintVectorToInputStream = Module["_addUintVectorToInputStream"] = wasmExports["Ld"];
  _addStringVectorToInputStream = Module["_addStringVectorToInputStream"] = wasmExports["Md"];
  _addFlatHashMapToInputStream = Module["_addFlatHashMapToInputStream"] = wasmExports["Nd"];
  _addProtoToInputStream = Module["_addProtoToInputStream"] = wasmExports["Od"];
  _addEmptyPacketToInputStream = Module["_addEmptyPacketToInputStream"] = wasmExports["Pd"];
  _addBoolToInputSidePacket = Module["_addBoolToInputSidePacket"] = wasmExports["Qd"];
  _addDoubleToInputSidePacket = Module["_addDoubleToInputSidePacket"] = wasmExports["Rd"];
  _addFloatToInputSidePacket = Module["_addFloatToInputSidePacket"] = wasmExports["Sd"];
  _addIntToInputSidePacket = Module["_addIntToInputSidePacket"] = wasmExports["Td"];
  _addUintToInputSidePacket = Module["_addUintToInputSidePacket"] = wasmExports["Ud"];
  _addStringToInputSidePacket = Module["_addStringToInputSidePacket"] = wasmExports["Vd"];
  _addRawDataSpanToInputSidePacket = Module["_addRawDataSpanToInputSidePacket"] = wasmExports["Wd"];
  _addProtoToInputSidePacket = Module["_addProtoToInputSidePacket"] = wasmExports["Xd"];
  _addBoolVectorToInputSidePacket = Module["_addBoolVectorToInputSidePacket"] = wasmExports["Yd"];
  _addDoubleVectorToInputSidePacket = Module["_addDoubleVectorToInputSidePacket"] = wasmExports["Zd"];
  _addFloatVectorToInputSidePacket = Module["_addFloatVectorToInputSidePacket"] = wasmExports["_d"];
  _addIntVectorToInputSidePacket = Module["_addIntVectorToInputSidePacket"] = wasmExports["$d"];
  _addUintVectorToInputSidePacket = Module["_addUintVectorToInputSidePacket"] = wasmExports["ae"];
  _addStringVectorToInputSidePacket = Module["_addStringVectorToInputSidePacket"] = wasmExports["be"];
  _attachBoolListener = Module["_attachBoolListener"] = wasmExports["ce"];
  _attachBoolVectorListener = Module["_attachBoolVectorListener"] = wasmExports["de"];
  _attachDoubleListener = Module["_attachDoubleListener"] = wasmExports["ee"];
  _attachDoubleVectorListener = Module["_attachDoubleVectorListener"] = wasmExports["fe"];
  _attachFloatListener = Module["_attachFloatListener"] = wasmExports["ge"];
  _attachFloatVectorListener = Module["_attachFloatVectorListener"] = wasmExports["he"];
  _attachIntListener = Module["_attachIntListener"] = wasmExports["ie"];
  _attachIntVectorListener = Module["_attachIntVectorListener"] = wasmExports["je"];
  _attachUintListener = Module["_attachUintListener"] = wasmExports["ke"];
  _attachUintVectorListener = Module["_attachUintVectorListener"] = wasmExports["le"];
  _attachStringListener = Module["_attachStringListener"] = wasmExports["me"];
  _attachStringVectorListener = Module["_attachStringVectorListener"] = wasmExports["ne"];
  _attachProtoListener = Module["_attachProtoListener"] = wasmExports["oe"];
  _attachProtoVectorListener = Module["_attachProtoVectorListener"] = wasmExports["pe"];
  _getGraphConfig = Module["_getGraphConfig"] = wasmExports["qe"];
  ___getTypeName = wasmExports["re"];
  _emwgpuCreateBindGroup = wasmExports["se"];
  _emwgpuCreateBindGroupLayout = wasmExports["te"];
  _emwgpuCreateCommandBuffer = wasmExports["ue"];
  _emwgpuCreateCommandEncoder = wasmExports["ve"];
  _emwgpuCreateComputePassEncoder = wasmExports["we"];
  _emwgpuCreateComputePipeline = wasmExports["xe"];
  _emwgpuCreateExternalTexture = wasmExports["ye"];
  _emwgpuCreatePipelineLayout = wasmExports["ze"];
  _emwgpuCreateQuerySet = wasmExports["Ae"];
  _emwgpuCreateRenderBundle = wasmExports["Be"];
  _emwgpuCreateRenderBundleEncoder = wasmExports["Ce"];
  _emwgpuCreateRenderPassEncoder = wasmExports["De"];
  _emwgpuCreateRenderPipeline = wasmExports["Ee"];
  _emwgpuCreateSampler = wasmExports["Fe"];
  _emwgpuCreateSurface = wasmExports["Ge"];
  _emwgpuCreateTexture = wasmExports["He"];
  _emwgpuCreateTextureView = wasmExports["Ie"];
  _emwgpuCreateAdapter = wasmExports["Je"];
  _emwgpuImportBuffer = wasmExports["Ke"];
  _emwgpuCreateDevice = wasmExports["Le"];
  _emwgpuCreateQueue = wasmExports["Me"];
  _emwgpuCreateShaderModule = wasmExports["Ne"];
  _emwgpuOnCreateComputePipelineCompleted = wasmExports["Oe"];
  _emwgpuOnWorkDoneCompleted = wasmExports["Pe"];
  ...
  _processGl = Module["_processGl"] = wasmExports["Ve"];
  _process = Module["_process"] = wasmExports["We"];
  ...
  _closeGraph = Module["_closeGraph"] = wasmExports["_e"];
  _setAutoRenderToScreen = Module["_setAutoRenderToScreen"] = wasmExports["$e"];
  _emscripten_builtin_memalign = wasmExports["af"];
  _memalign = wasmExports["bf"];
  __emscripten_tempret_set = wasmExports["cf"];
  __emscripten_stack_restore = wasmExports["df"];
  __emscripten_stack_alloc = wasmExports["ef"];
  _emscripten_stack_get_current = wasmExports["ff"];
  dynCall_vii = dynCalls["vii"] = wasmExports["gf"];
  dynCall_viiiiiii = dynCalls["viiiiiii"] = wasmExports["hf"];
  dynCall_viiiiii = dynCalls["viiiiii"] = wasmExports["jf"];
  dynCall_v = dynCalls["v"] = wasmExports["kf"];
  dynCall_ii = dynCalls["ii"] = wasmExports["lf"];
  dynCall_vi = dynCalls["vi"] = wasmExports["mf"];
  dynCall_iiiii = dynCalls["iiiii"] = wasmExports["nf"];
  dynCall_iii = dynCalls["iii"] = wasmExports["of"];
  dynCall_viii = dynCalls["viii"] = wasmExports["pf"];
  dynCall_i = dynCalls["i"] = wasmExports["qf"];
  dynCall_ji = dynCalls["ji"] = wasmExports["rf"];
  dynCall_iiii = dynCalls["iiii"] = wasmExports["sf"];
  dynCall_viiii = dynCalls["viiii"] = wasmExports["tf"];
  dynCall_viiiii = dynCalls["viiiii"] = wasmExports["uf"];
  dynCall_jii = dynCalls["jii"] = wasmExports["vf"];
  dynCall_iiiijij = dynCalls["iiiijij"] = wasmExports["wf"];
  dynCall_ff = dynCalls["ff"] = wasmExports["xf"];
  dynCall_did = dynCalls["did"] = wasmExports["yf"];
  dynCall_iiiiiii = dynCalls["iiiiiii"] = wasmExports["zf"];
  dynCall_iiiiii = dynCalls["iiiiii"] = wasmExports["Af"];
  dynCall_iiiiiiiiiii = dynCalls["iiiiiiiiiii"] = wasmExports["Bf"];
  dynCall_iiiiiiiiiiii = dynCalls["iiiiiiiiiiii"] = wasmExports["Cf"];
  dynCall_viji = dynCalls["viji"] = wasmExports["Df"];
  dynCall_vijiii = dynCalls["vijiii"] = wasmExports["Ef"];
  dynCall_iiiiiiiii = dynCalls["iiiiiiiii"] = wasmExports["Ff"];
  dynCall_viiiiiiii = dynCalls["viiiiiiii"] = wasmExports["Gf"];
  dynCall_iiiif = dynCalls["iiiif"] = wasmExports["Hf"];
  dynCall_viiiiiiiiiiiiiii = dynCalls["viiiiiiiiiiiiiii"] = wasmExports["If"];
  dynCall_viff = dynCalls["viff"] = wasmExports["Jf"];
  dynCall_viiffii = dynCalls["viiffii"] = wasmExports["Kf"];
  dynCall_viiffi = dynCalls["viiffi"] = wasmExports["Lf"];
  dynCall_viiiiiiiiii = dynCalls["viiiiiiiiii"] = wasmExports["Mf"];
  dynCall_fi = dynCalls["fi"] = wasmExports["Nf"];
  dynCall_viiffff = dynCalls["viiffff"] = wasmExports["Of"];
  dynCall_viiiiij = dynCalls["viiiiij"] = wasmExports["Pf"];
  dynCall_vij = dynCalls["vij"] = wasmExports["Qf"];
  dynCall_viiiiiffii = dynCalls["viiiiiffii"] = wasmExports["Rf"];
  dynCall_vif = dynCalls["vif"] = wasmExports["Sf"];
  dynCall_ddd = dynCalls["ddd"] = wasmExports["Tf"];
  dynCall_dddd = dynCalls["dddd"] = wasmExports["Uf"];
  dynCall_idd = dynCalls["idd"] = wasmExports["Vf"];
  dynCall_di = dynCalls["di"] = wasmExports["Wf"];
  dynCall_jiiiijiiiii = dynCalls["jiiiijiiiii"] = wasmExports["Xf"];
  dynCall_viiij = dynCalls["viiij"] = wasmExports["Yf"];
  dynCall_viid = dynCalls["viid"] = wasmExports["Zf"];
  dynCall_vidd = dynCalls["vidd"] = wasmExports["_f"];
  dynCall_vifd = dynCalls["vifd"] = wasmExports["$f"];
  dynCall_viiiiiiiiiii = dynCalls["viiiiiiiiiii"] = wasmExports["ag"];
  dynCall_iiif = dynCalls["iiif"] = wasmExports["bg"];
  dynCall_jiii = dynCalls["jiii"] = wasmExports["cg"];
  dynCall_viijj = dynCalls["viijj"] = wasmExports["dg"];
  dynCall_iiiiiiii = dynCalls["iiiiiiii"] = wasmExports["eg"];
  dynCall_iiiiiiiiii = dynCalls["iiiiiiiiii"] = wasmExports["fg"];
  dynCall_iij = dynCalls["iij"] = wasmExports["gg"];
  dynCall_iiiijj = dynCalls["iiiijj"] = wasmExports["hg"];
  dynCall_viiijjj = dynCalls["viiijjj"] = wasmExports["ig"];
  dynCall_fff = dynCalls["fff"] = wasmExports["jg"];
  dynCall_viifii = dynCalls["viifii"] = wasmExports["kg"];
  dynCall_fii = dynCalls["fii"] = wasmExports["lg"];
  dynCall_jjj = dynCalls["jjj"] = wasmExports["mg"];
  dynCall_fiii = dynCalls["fiii"] = wasmExports["ng"];
  dynCall_viiiiiiiii = dynCalls["viiiiiiiii"] = wasmExports["og"];
  dynCall_viiiffii = dynCalls["viiiffii"] = wasmExports["pg"];
  dynCall_iiiiiffi = dynCalls["iiiiiffi"] = wasmExports["qg"];
  dynCall_viiiiiff = dynCalls["viiiiiff"] = wasmExports["rg"];
  dynCall_viiiiiiiiiiiii = dynCalls["viiiiiiiiiiiii"] = wasmExports["sg"];
  dynCall_viiiiiiiiiiii = dynCalls["viiiiiiiiiiii"] = wasmExports["tg"];
  dynCall_viiiiiiiiiiiiiiiii = dynCalls["viiiiiiiiiiiiiiiii"] = wasmExports["ug"];
  dynCall_iifff = dynCalls["iifff"] = wasmExports["vg"];
  dynCall_iiff = dynCalls["iiff"] = wasmExports["wg"];
  dynCall_iiifiii = dynCalls["iiifiii"] = wasmExports["xg"];
  dynCall_iiffi = dynCalls["iiffi"] = wasmExports["yg"];
  dynCall_iiffii = dynCalls["iiffii"] = wasmExports["zg"];
  dynCall_viiiiiiiiiiiiii = dynCalls["viiiiiiiiiiiiii"] = wasmExports["Ag"];
  dynCall_iif = dynCalls["iif"] = wasmExports["Bg"];
  dynCall_viijii = dynCalls["viijii"] = wasmExports["Cg"];
  dynCall_iiiji = dynCalls["iiiji"] = wasmExports["Dg"];
  dynCall_viiif = dynCalls["viiif"] = wasmExports["Eg"];
  dynCall_viiifiii = dynCalls["viiifiii"] = wasmExports["Fg"];
  dynCall_fiif = dynCalls["fiif"] = wasmExports["Gg"];
  dynCall_iiiifi = dynCalls["iiiifi"] = wasmExports["Hg"];
  dynCall_iiiifiii = dynCalls["iiiifiii"] = wasmExports["Ig"];
  dynCall_iiifi = dynCalls["iiifi"] = wasmExports["Jg"];
  dynCall_viiiif = dynCalls["viiiif"] = wasmExports["Kg"];
  dynCall_viiiifii = dynCalls["viiiifii"] = wasmExports["Lg"];
  dynCall_dii = dynCalls["dii"] = wasmExports["Mg"];
  dynCall_vifi = dynCalls["vifi"] = wasmExports["Ng"];
  dynCall_vidi = dynCalls["vidi"] = wasmExports["Og"];
  dynCall_viiiji = dynCalls["viiiji"] = wasmExports["Pg"];
  dynCall_viiji = dynCalls["viiji"] = wasmExports["Qg"];
  dynCall_vijjj = dynCalls["vijjj"] = wasmExports["Rg"];
  dynCall_vj = dynCalls["vj"] = wasmExports["Sg"];
  dynCall_viij = dynCalls["viij"] = wasmExports["Tg"];
  dynCall_jiji = dynCalls["jiji"] = wasmExports["Ug"];
  dynCall_iidiiii = dynCalls["iidiiii"] = wasmExports["Vg"];
  dynCall_iiiiij = dynCalls["iiiiij"] = wasmExports["Wg"];
  dynCall_iiiiid = dynCalls["iiiiid"] = wasmExports["Xg"];
  dynCall_iiiiijj = dynCalls["iiiiijj"] = wasmExports["Yg"];
  dynCall_iiiiiijj = dynCalls["iiiiiijj"] = wasmExports["Zg"];
  _asyncify_start_unwind = wasmExports["_g"];
  _asyncify_stop_unwind = wasmExports["$g"];
  _asyncify_start_rewind = wasmExports["ah"];
  _asyncify_stop_rewind = wasmExports["bh"];
  memory = wasmMemory = wasmExports["rc"];
  _kVersionStampBuildChangelistStr = Module["_kVersionStampBuildChangelistStr"] = (wasmExports["tc"].value) >>> 0;
  _kVersionStampCitcSnapshotStr = Module["_kVersionStampCitcSnapshotStr"] = (wasmExports["uc"].value) >>> 0;
  _kVersionStampCitcWorkspaceIdStr = Module["_kVersionStampCitcWorkspaceIdStr"] = (wasmExports["vc"].value) >>> 0;
  _kVersionStampSourceUriStr = Module["_kVersionStampSourceUriStr"] = (wasmExports["wc"].value) >>> 0;
  _kVersionStampBuildClientStr = Module["_kVersionStampBuildClientStr"] = (wasmExports["xc"].value) >>> 0;
  _kVersionStampBuildClientMintStatusStr = Module["_kVersionStampBuildClientMintStatusStr"] = (wasmExports["yc"].value) >>> 0;
  _kVersionStampBuildCompilerStr = Module["_kVersionStampBuildCompilerStr"] = (wasmExports["zc"].value) >>> 0;
  _kVersionStampBuildDateTimePstStr = Module["_kVersionStampBuildDateTimePstStr"] = (wasmExports["Ac"].value) >>> 0;
  _kVersionStampBuildDepotPathStr = Module["_kVersionStampBuildDepotPathStr"] = (wasmExports["Bc"].value) >>> 0;
  _kVersionStampBuildIdStr = Module["_kVersionStampBuildIdStr"] = (wasmExports["Cc"].value) >>> 0;
  _kVersionStampBuildInfoStr = Module["_kVersionStampBuildInfoStr"] = (wasmExports["Dc"].value) >>> 0;
  _kVersionStampBuildLabelStr = Module["_kVersionStampBuildLabelStr"] = (wasmExports["Ec"].value) >>> 0;
  _kVersionStampBuildTargetStr = Module["_kVersionStampBuildTargetStr"] = (wasmExports["Fc"].value) >>> 0;
  _kVersionStampBuildTimestampStr = Module["_kVersionStampBuildTimestampStr"] = (wasmExports["Gc"].value) >>> 0;
  _kVersionStampBuildToolStr = Module["_kVersionStampBuildToolStr"] = (wasmExports["Hc"].value) >>> 0;
  _kVersionStampG3BuildTargetStr = Module["_kVersionStampG3BuildTargetStr"] = (wasmExports["Ic"].value) >>> 0;
  _kVersionStampVerifiableStr = Module["_kVersionStampVerifiableStr"] = (wasmExports["Jc"].value) >>> 0;
  _kVersionStampBuildFdoTypeStr = Module["_kVersionStampBuildFdoTypeStr"] = (wasmExports["Kc"].value) >>> 0;
  _kVersionStampBuildBaselineChangelistStr = Module["_kVersionStampBuildBaselineChangelistStr"] = (wasmExports["Lc"].value) >>> 0;
  _kVersionStampBuildLtoTypeStr = Module["_kVersionStampBuildLtoTypeStr"] = (wasmExports["Mc"].value) >>> 0;
  _kVersionStampBuildPropellerTypeStr = Module["_kVersionStampBuildPropellerTypeStr"] = (wasmExports["Nc"].value) >>> 0;
  _kVersionStampBuildPghoTypeStr = Module["_kVersionStampBuildPghoTypeStr"] = (wasmExports["Oc"].value) >>> 0;
  _kVersionStampBuildUsernameStr = Module["_kVersionStampBuildUsernameStr"] = (wasmExports["Pc"].value) >>> 0;
  _kVersionStampBuildHostnameStr = Module["_kVersionStampBuildHostnameStr"] = (wasmExports["Qc"].value) >>> 0;
  _kVersionStampBuildDirectoryStr = Module["_kVersionStampBuildDirectoryStr"] = (wasmExports["Rc"].value) >>> 0;
  _kVersionStampBuildChangelistInt = Module["_kVersionStampBuildChangelistInt"] = (wasmExports["Sc"].value) >>> 0;
  _kVersionStampCitcSnapshotInt = Module["_kVersionStampCitcSnapshotInt"] = (wasmExports["Tc"].value) >>> 0;
  _kVersionStampBuildClientMintStatusInt = Module["_kVersionStampBuildClientMintStatusInt"] = (wasmExports["Uc"].value) >>> 0;
  _kVersionStampBuildTimestampInt = Module["_kVersionStampBuildTimestampInt"] = (wasmExports["Vc"].value) >>> 0;
  _kVersionStampVerifiableInt = Module["_kVersionStampVerifiableInt"] = (wasmExports["Wc"].value) >>> 0;
  _kVersionStampBuildCoverageEnabledInt = Module["_kVersionStampBuildCoverageEnabledInt"] = (wasmExports["Xc"].value) >>> 0;
  _kVersionStampBuildBaselineChangelistInt = Module["_kVersionStampBuildBaselineChangelistInt"] = (wasmExports["Yc"].value) >>> 0;
  _kVersionStampPrecookedTimestampStr = Module["_kVersionStampPrecookedTimestampStr"] = (wasmExports["Zc"].value) >>> 0;
  _kVersionStampPrecookedClientInfoStr = Module["_kVersionStampPrecookedClientInfoStr"] = (wasmExports["_c"].value) >>> 0;
  __indirect_function_table = wasmExports["__indirect_function_table"];
}

var wasmImports = {
  /** @export */ pc: DefaultErrorReporter,
  /** @export */ oc: GetAdapterArchitecture,
  /** @export */ nc: GetAdapterDescription,
  /** @export */ mc: GetAdapterDeviceName,
  /** @export */ lc: GetAdapterVendor,
  /** @export */ jc: JsGetDeviceMaxSubgroupSize,
  /** @export */ ic: JsGetDeviceMinSubgroupSize,
  /** @export */ hc: JsOnEmptyPacketListener,
  /** @export */ la: JsOnSimpleListenerBinaryArray,
  /** @export */ gc: JsOnSimpleListenerBool,
  /** @export */ fc: JsOnSimpleListenerDouble,
  /** @export */ ec: JsOnSimpleListenerFloat,
  /** @export */ dc: JsOnSimpleListenerInt,
  /** @export */ cc: JsOnSimpleListenerString,
  /** @export */ bc: JsOnSimpleListenerUint,
  /** @export */ p: JsOnVectorFinishedListener,
  /** @export */ ac: JsOnVectorListenerBool,
  /** @export */ $b: JsOnVectorListenerDouble,
  /** @export */ _b: JsOnVectorListenerFloat,
  /** @export */ Zb: JsOnVectorListenerInt,
  /** @export */ Yb: JsOnVectorListenerProto,
  /** @export */ Xb: JsOnVectorListenerString,
  /** @export */ Wb: JsOnVectorListenerUint,
  /** @export */ ka: JsProgressListener,
  /** @export */ J: JsWrapErrorListener,
  /** @export */ g: JsWrapSimpleListeners,
  /** @export */ Vb: ThrowError,
  /** @export */ ja: UseBottomLeftGpuOrigin,
  /** @export */ Ub: __Unwind_RaiseException,
  /** @export */ qc: __asyncjs__CallReadDataFn,
  /** @export */ kc: __asyncjs__InvokeReadDataFn,
  /** @export */ I: __asyncjs__ReadBufferDataJs,
  /** @export */ Da: __asyncjs__mediapipe_map_buffer_jspi,
  /** @export */ Tb: ___syscall_dup,
  /** @export */ Sb: ___syscall_faccessat,
  /** @export */ ia: ___syscall_fcntl64,
  /** @export */ Rb: ___syscall_fstat64,
  /** @export */ Ua: ___syscall_ftruncate64,
  /** @export */ Qb: ___syscall_getcwd,
  /** @export */ Pb: ___syscall_getdents64,
  /** @export */ Ob: ___syscall_ioctl,
  /** @export */ Nb: ___syscall_lstat64,
  /** @export */ Mb: ___syscall_mkdirat,
  /** @export */ Lb: ___syscall_newfstatat,
  ...
  /** @export */ ea: __emval_create_invoker,
  /** @export */ l: __emval_decref,
  /** @export */ o: __emval_incref,
  /** @export */ da: __emval_invoke,
  /** @export */ ca: __emval_run_destructors,
  ...
  /** @export */ $: _emscripten_webgpu_get_device,
  ...
  /** @export */ Ra: _fd_seek,
  /** @export */ y: _fd_write,
  /** @export */ F: _glActiveTexture,
  /** @export */ _: _glAttachShader,
  /** @export */ gb: _glBindAttribLocation,
  /** @export */ m: _glBindBuffer,
  /** @export */ w: _glBindFramebuffer,
  /** @export */ k: _glBindTexture,
  /** @export */ E: _glBufferData,
  /** @export */ q: _glClientWaitSync,
  /** @export */ fb: _glCompileShader,
  /** @export */ eb: _glCreateProgram,
  /** @export */ db: _glCreateShader,
  /** @export */ Z: _glDeleteFramebuffers,
  /** @export */ cb: _glDeleteProgram,
  /** @export */ Y: _glDeleteShader,
  /** @export */ v: _glDeleteSync,
  /** @export */ X: _glDeleteTextures,
  /** @export */ W: _glDetachShader,
  /** @export */ V: _glDisableVertexAttribArray,
  /** @export */ bb: _glDrawArrays,
  /** @export */ U: _glEnableVertexAttribArray,
  /** @export */ T: _glFenceSync,
  /** @export */ u: _glFinish,
  /** @export */ D: _glFramebufferTexture2D,
  /** @export */ S: _glGenBuffers,
  /** @export */ ab: _glGenFramebuffers,
  /** @export */ C: _glGenTextures,
  /** @export */ t: _glGetError,
  /** @export */ R: _glGetIntegerv,
  /** @export */ B: _glGetString,
  /** @export */ $a: _glGetUniformLocation,
  /** @export */ _a: _glLinkProgram,
  /** @export */ A: _glPixelStorei,
  /** @export */ Q: _glReadPixels,
  /** @export */ Za: _glShaderSource,
  /** @export */ Ya: _glTexImage2D,
  /** @export */ j: _glTexParameteri,
  /** @export */ P: _glTexStorage2D,
  /** @export */ Xa: _glUniform1i,
  /** @export */ Wa: _glUseProgram,
  /** @export */ O: _glVertexAttribPointer,
  /** @export */ Va: _glViewport,
  ...
  /** @export */ N: _wgpuCommandEncoderCopyTextureToBuffer,
  /** @export */ Ca: _wgpuCommandEncoderCopyTextureToTexture,
  ...
  /** @export */ za: _wgpuDeviceCreateBindGroupLayout,
  /** @export */ b: _wgpuDeviceCreateCommandEncoder,
  /** @export */ ya: _wgpuDeviceCreateComputePipeline,
  /** @export */ xa: _wgpuDeviceCreatePipelineLayout,
  /** @export */ wa: _wgpuDeviceCreateQuerySet,
  /** @export */ va: _wgpuDeviceCreateTexture,
  /** @export */ K: _wgpuDeviceGetAdapterInfo,
  /** @export */ ua: _wgpuDeviceGetLimits,
  /** @export */ ta: _wgpuDeviceHasFeature,
  /** @export */ a: _wgpuQueueSubmit,
  /** @export */ Ea: _wgpuQueueWriteBuffer,
  /** @export */ sa: _wgpuQueueWriteTexture,
  /** @export */ ra: _wgpuTextureCreateView,
  /** @export */ qa: _wgpuTextureDestroy,
  /** @export */ pa: _wgpuTextureGetDepthOrArrayLayers,
  /** @export */ oa: _wgpuTextureGetFormat,
  /** @export */ na: _wgpuTextureGetHeight,
  /** @export */ ma: _wgpuTextureGetWidth
};
...
function applySignatureConversions(wasmExports) {
  ...
  wasmExports["gd"] = makeWrapper_pp(wasmExports["gd"]);
  wasmExports["re"] = makeWrapper_pp(wasmExports["re"]);
  wasmExports["af"] = makeWrapper_ppp(wasmExports["af"]);
  wasmExports["bf"] = makeWrapper_ppp(wasmExports["bf"]);
  wasmExports["ef"] = makeWrapper_pp(wasmExports["ef"]);
  wasmExports["ff"] = makeWrapper_p(wasmExports["ff"]);
  return wasmExports;
}
